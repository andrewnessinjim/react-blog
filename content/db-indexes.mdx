...
in pages <InfoPopover>a collection of rows</InfoPopover>, not one row at a time. I'll cover this in a future post, but you can get into the details in [Markus Winand's book][2].
