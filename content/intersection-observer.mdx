...
<SandpackDemo projectSubDir="interactionObserver/scaleOnEntry" />
...
<SandpackDemo projectSubDir="interactionObserver/exerciseSolution" />
...
<SandpackDemo
  projectSubDir="interactionObserver/infiniteScrolling"
  customSetup={{
    dependencies: {
